...
public class PlayListPrivadaDAO {
    ...
    //insere playlist privada no banco
    ...
    //busca playlist privadas do banco, retorna elas
    //entra com o array dos usuarios pra ir atualizando as relacoes
    public ArrayList<PlayListPrivada> buscarPlayListPrivada(ArrayList<Usuario> usuarios) {
        ...
        try {
            String sql = "SELECT idPlayListPrivada, nomePlayListPrivada, qtdMusicasPlayListPrivada, idUsuario FROM playListPrivada";
            pstmt = conector.getConexao().prepareStatement(sql);
    ...
    //apaga todas as playlists privadas do banco
    //retorna o numero de registros apagados
    public int apagarPlayListPrivada() {
        ...
        try { 
            sql = "DELETE FROM playListPrivada";
            pstmt = conector.getConexao().prepareStatement(sql);  
            resultado = pstmt.executeUpdate(); 
